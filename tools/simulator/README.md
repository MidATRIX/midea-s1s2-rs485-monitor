...
-----
 Must run in a seperate terminal window from main.py
  ...
  python3 simulator.py HeatModeSample.db 0321 - This will start at a defrost cycle
  python3 simulator.py CoolModeSample.db 1052 - This will start at the begining of a 8 hour cycle which includes multiple oil returns and step searching for better higher loads. See image below
...
Cool Mode HZ
------
Reference for cool mode sample
